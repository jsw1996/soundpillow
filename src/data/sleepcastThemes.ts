import { SleepcastTheme } from '../types';

export const SLEEPCAST_THEMES: SleepcastTheme[] = [
  {
    id: 'cabin-rain',
    name: 'Rainy Cabin',
    icon: 'CloudRain',
    ...
    bgTrackIds: ['1', '7'], // Tropical Rain + Forest Bonfire
  },
  {
    id: 'ocean-voyage',
    name: 'Ocean Voyage',
    ...
    bgTrackIds: ['3', '6'], // Ocean Waves + Silent Snow (wind)
  },
  {
    id: 'enchanted-forest',
    ...
    bgTrackIds: ['2', '11'], // Midnight Forest + Gentle River
  },
  {
    id: 'zen-garden',
    name: 'Zen Garden',
    ...
    bgTrackIds: ['9', '10'], // Singing Bowl + Wind Chimes
  },
  {
    id: 'stargazing',
    name: 'Stargazing',
    ...
    bgTrackIds: ['5', '14'], // Morning Mist (birds/nature) + Delta Waves
  },
  {
    id: 'snow-lodge',
    name: 'Snow Lodge',
    ...
    bgTrackIds: ['6', '7'], // Silent Snow + Forest Bonfire
  },
];
